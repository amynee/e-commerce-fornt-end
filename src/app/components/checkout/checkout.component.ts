  ...
  ngOnInit(): void {
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      customer: this.formBuilder.group({
        ...
        email: new FormControl(email, [Validators.required, Validators.pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$'), FormValidators.notOnlyWhiteSpace])}),
      shippingAddress: this.formBuilder.group({
        ...
        zipCode: new FormControl('', [Validators.required, Validators.minLength(6), FormValidators.notOnlyWhiteSpace]),
      }),
    ...
    // populate countries
    this.shopFormService.getCountires().subscribe(
